export default {
  ...
  profilePage: {
    ...
    communicationSaved: "The information has been successfully saved.",
    communicationError: "Error saving the information.",
    noCommunicationData: "No data.",
    paidTooltip: "The buyer has paid for the item.",
    paymentReceivedTooltip: "The seller has received the payment.",
    sentTooltip: "The seller has shipped the item.",
    packageReceivedTooltip: "The buyer has received the item.",
    packageMatchesTooltip: "The shipment matches the description.",
    packageDoesNotMatchTooltip: "The shipment does not match the description.",
    shippingDate: "Shipping date",
    trackingNumber: "Tracking number",
    deleteCommunicationRecord: "Delete previous entry",
    packageMatches: "Item matches description",
    packageDoesNotMatch: "Item does not match description",
  },
